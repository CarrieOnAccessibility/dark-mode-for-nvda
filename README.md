...
- A solid focus ring on every control (check boxes, dropdowns, sliders and list rows included), an outline on the highlighted menu item, and a coloured selected row in lists; a "Focus outline thickness" slider makes the rings 1 to 4 pixels.
